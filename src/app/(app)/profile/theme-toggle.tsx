...
export function ThemeToggleRow() {
  ...
  return (
    ...
    >
      {theme === "light" ? (
        <Moon className="w-5 h-5" style={{ color: "var(--mf-text-muted)" }} />
      ) : (
        <Sun className="w-5 h-5" style={{ color: "var(--mf-text-muted)" }} />
      )}
      ...
      <div
        ...
        style={{ background: theme === "dark" ? "var(--forest)" : "var(--mf-border)" }}
      >
        <div
