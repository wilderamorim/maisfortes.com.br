...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      ...
      <p className="text-sm mb-8" style={{ color: "var(--mf-text-muted)" }}>Juntos, somos mais fortes</p>

      <button onClick={handleGoogleLogin} type="button" className="w-full py-3 rounded-xl font-medium text-sm transition-all active:scale-[0.98] flex items-center justify-center gap-2 mb-6" style={{ background: "var(--mf-surface)", border: "1px solid var(--mf-border)", color: "var(--mf-text)" }}>
