    ...
    <div className="relative" style={{ animation: "float 6s ease-in-out infinite" }}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "var(--shadow-lg), 0 0 40px rgba(45,106,79,0.1)",
        }}
      >
        {/* Notch */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-6 rounded-b-2xl" style={{ background: "var(--bg)" }} />

        {/* Screen */}
        <div className="rounded-[24px] overflow-hidden" style={{ background: "var(--bg)" }}>
          {/* Status bar */}
          <div className="h-10 flex items-end justify-between px-5 pb-1">
            <span className="text-[10px] font-mono" style={{ color: "var(--text-muted)" }}>9:41</span>
            <div className="flex gap-1">
              <div className="w-4 h-2 rounded-sm" style={{ background: "var(--text-muted)" }} />
          ...
          <div className="px-4 pt-2 pb-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-[8px]" style={{ color: "var(--text-muted)" }}>Oi, Wilder</p>
                <p className="text-xs font-bold" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>Como vai hoje?</p>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-[9px] font-semibold" style={{ color: "var(--text)" }}>Parar de beber</span>
            ...
            <div
              ...
              style={{ background: "var(--surface)", border: "1px solid var(--border-subtle)" }}
            >
              <p className="text-[9px] font-semibold mb-2" style={{ color: "var(--text)" }}>Como foi hoje?</p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[7px]" style={{ color: "var(--text-muted)" }}>14 dias de streak</p>
              </div>
            </div>
          </div>

          {/* Bottom tab bar */}
          <div className="h-12 flex items-center justify-around border-t" style={{ borderColor: "var(--border-subtle)" }}>
            {[
              ...
              <div key={i} className="flex items-center justify-center">
                {tab.isMain ? (
                  ...
                  <tab.icon className="w-4 h-4" style={{ color: tab.active ? "var(--forest)" : "var(--text-muted)" }} />
                )}
              </div>
            ))}
          </div>
