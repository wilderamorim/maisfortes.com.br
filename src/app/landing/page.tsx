...
export default function LandingPage() {
  return (
    <div className="min-h-dvh" style={{ background: "var(--bg)" }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ background: "color-mix(in srgb, var(--bg) 85%, transparent)", borderBottom: "1px solid var(--border-subtle)" }}>
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold text-sm leading-none" style={{ background: "var(--forest)" }}>+</div>
            <span className="font-bold text-sm" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>Fortes</span>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/auth/login" className="hidden sm:inline-block px-4 py-2 rounded-lg text-xs font-semibold transition-all" style={{ color: "var(--text-secondary)" }}>
              Entrar
            </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href="/auth/register" className="px-8 py-3.5 rounded-xl text-white font-semibold text-sm inline-flex items-center justify-center gap-2 transition-all active:scale-[0.98]" style={{ background: "var(--forest)", boxShadow: "var(--shadow-glow)" }}>
                  Comece sua jornada <ArrowRight className="w-4 h-4" />
                </Link>
                <a href="#como-funciona" className="px-8 py-3.5 rounded-xl font-semibold text-sm inline-flex items-center justify-center transition-all" style={{ border: "1px solid var(--border)", color: "var(--text-secondary)" }}>
                  Como funciona
                </a>
              </div>
            </div>
      ...
      {/* ═══════════════ STATS TICKER ═══════════════ */}
      <section className="py-6 border-y" style={{ borderColor: "var(--border-subtle)", background: "var(--bg)" }}>
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-8 text-center">
            <ScrollReveal>
              <div>
                <AnimatedCounter target={13} suffix="" />
                <p className="text-xs mt-1" style={{ color: "var(--text-muted)" }}>conquistas para desbloquear</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <div>
                <AnimatedCounter target={26} suffix="" />
                <p className="text-xs mt-1" style={{ color: "var(--text-muted)" }}>features no MVP</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={200}>
              <div>
                <AnimatedCounter target={0} prefix="R$" suffix="" />
                <p className="text-xs mt-1" style={{ color: "var(--text-muted)" }}>para sempre</p>
              </div>
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold mt-3 mb-4" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <ScrollReveal key={item.text} delay={i * 100}>
                <div className="flex items-start gap-3 rounded-xl p-4" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={pillar.title} delay={i * 150}>
                <div className="rounded-2xl p-8 text-center h-full" style={{ background: "var(--bg)", border: "1px solid var(--border-subtle)" }}>
                  ...
                  <h3 className="text-lg font-bold mb-2" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>{pillar.title}</h3>
                  <p className="text-sm" style={{ color: "var(--text-muted)" }}>{pillar.desc}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              <span className="text-xs font-mono uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>Features</span>
              <h2 className="text-3xl font-bold mt-3 mb-3" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f, i) => (
              <ScrollReveal key={f.title} delay={i * 80}>
                <div className="rounded-xl p-6 transition-all hover:shadow-md group" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
      ...
      {/* ═══════════════ COMO FUNCIONA ═══════════════ */}
      <section id="como-funciona" className="py-20" style={{ background: "var(--bg-secondary)" }}>
        <div className="max-w-3xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              <span className="text-xs font-mono uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>Passo a passo</span>
              <h2 className="text-3xl font-bold mt-3 mb-3" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
                Como funciona
              </h2>
          ...
          <div className="space-y-1">
            {steps.map((s, i) => (
              <ScrollReveal key={s.num} delay={i * 120}>
                <div className="flex gap-5 items-start rounded-xl p-5 transition-all" style={{ background: "var(--bg)", border: "1px solid var(--border-subtle)" }}>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <p style={{ color: "var(--text-muted)" }}>De Bronze a Diamante. Cada marco merece ser celebrado.</p>
            </div>
          </ScrollReveal>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
            {achievements.map((a, i) => (
              <ScrollReveal key={a.name} delay={i * 80}>
                <div className="rounded-xl p-4 text-center" style={{ background: `color-mix(in srgb, ${a.color} 8%, var(--bg-secondary))`, border: `1px solid color-mix(in srgb, ${a.color} 20%, transparent)` }}>
                  ...
                  <p className="text-[10px] font-semibold" style={{ color: "var(--text)" }}>{a.name}</p>
      ...
      <section className="py-20" style={{ background: "var(--bg-secondary)" }}>
        <div className="max-w-3xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              <span className="text-xs font-mono uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>Por que +Fortes?</span>
              <h2 className="text-3xl font-bold mt-3" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
          ...
          <div className="space-y-3">
            {comparisons.map((c, i) => (
              <ScrollReveal key={c.them} delay={i * 100}>
                <div className="rounded-xl p-5" style={{ background: "var(--bg)", border: "1px solid var(--border-subtle)" }}>
                  ...
                  <p className="text-sm" style={{ color: "var(--text-secondary)" }}>{c.diff}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              <span className="text-xs font-mono uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>Depoimentos</span>
              <h2 className="text-3xl font-bold mt-3" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
                Histórias reais
              </h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {testimonials.map((t, i) => (
              <ScrollReveal key={i} delay={i * 100}>
                <div className="rounded-xl p-6 h-full flex flex-col" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
                  <div className="flex gap-0.5 mb-4">
                    {[1,2,3,4,5].map((s) => (
                      <Star key={s} className="w-3.5 h-3.5 fill-current" style={{ color: "var(--amber)" }} />
                    ))}
                  </div>
                  <p className="text-sm flex-1 mb-4" style={{ color: "var(--text-secondary)" }}>"{t.text}"</p>
                  <p className="text-xs font-mono" style={{ color: "var(--text-muted)" }}>— {t.author}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-20" style={{ background: "var(--bg-secondary)" }}>
        <div className="max-w-3xl mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-4 text-center relative z-10">
          <ScrollReveal>
            ...
            <Link href="/auth/register" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-white font-semibold transition-all active:scale-[0.98]" style={{ background: "var(--forest)", boxShadow: "var(--shadow-glow)" }}>
      ...
      {/* ═══════════════ FOOTER ═══════════════ */}
      <footer className="py-10 border-t" style={{ borderColor: "var(--border-subtle)" }}>
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-start justify-between gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white text-xs font-bold leading-none" style={{ background: "var(--forest)" }}>+</div>
                <span className="font-bold text-sm" style={{ color: "var(--text)", fontFamily: "var(--font-display)" }}>Fortes</span>
              </div>
            ...
            <div className="flex gap-12">
              <div>
                <h4 className="text-xs font-semibold mb-3" style={{ color: "var(--text)" }}>Produto</h4>
                <div className="space-y-2">
                  <a href="#como-funciona" className="text-xs block" style={{ color: "var(--text-muted)" }}>Como funciona</a>
                  <Link href="/auth/register" className="text-xs block" style={{ color: "var(--text-muted)" }}>Criar conta</Link>
                  <a href="https://brand.maisfortes.com.br" target="_blank" rel="noopener" className="text-xs block" style={{ color: "var(--text-muted)" }}>Brandbook</a>
                </div>
              </div>
              <div>
                <h4 className="text-xs font-semibold mb-3" style={{ color: "var(--text)" }}>Legal</h4>
                <div className="space-y-2">
                  <Link href="/termos" className="text-xs block" style={{ color: "var(--text-muted)" }}>Termos de uso</Link>
                  <Link href="/privacidade" className="text-xs block" style={{ color: "var(--text-muted)" }}>Política de privacidade</Link>
                </div>
              </div>
              <div>
                <h4 className="text-xs font-semibold mb-3" style={{ color: "var(--text)" }}>Open-source</h4>
                <div className="space-y-2">
                  <a href="https://github.com/wilderamorim/maisfortes.com.br" target="_blank" rel="noopener" className="text-xs block" style={{ color: "var(--text-muted)" }}>GitHub</a>
                  <a href="https://github.com/wilderamorim/maisfortes.com.br/blob/main/LICENSE" target="_blank" rel="noopener" className="text-xs block" style={{ color: "var(--text-muted)" }}>Licença MIT</a>
                </div>
              </div>
            </div>
          </div>
          <div className="mt-8 pt-6 border-t flex items-center justify-between" style={{ borderColor: "var(--border-subtle)" }}>
            <span className="text-[10px] font-mono" style={{ color: "var(--text-muted)" }}>+Fortes — Juntos, somos mais fortes.</span>
            <span className="text-[10px] font-mono" style={{ color: "var(--text-muted)" }}>&copy; 2026</span>
          </div>
        </div>
      </footer>
    </div>
